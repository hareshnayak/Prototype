...
class InstaParserExampleApp extends StatefulWidget {
  ...
  InstaParserExampleApp({Key key, this.scaffoldKey, this.postUrl}) : super(key: key);
...
class _InstaParserExampleAppState extends State<InstaParserExampleApp> {
  ...
  void initState() {
    super.initState();
    _profileUrlController.text = 'https://www.instagram.com/himeshnayak.8/';
    _postUrlController.text = widget.postUrl;
  }
                      ...
                      child: Form(
                          child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                  ...
                                  hintText: 'https://www.instagram.com/himeshnayak.8/',
